 ...
 * The test results:
 *
 * BOOS Core 3.0 & TI TMS320C6457 @ 1000 MHz
 ...
 * 1_750_000_000 ns
 *
 * EOOS RT 0.1.0 & TI TMS320C6457 @ 1000 MHz
 * 1_774_961_641 ns : unfair
 * 1_820_033_599 ns : fair 
 *
...
int32 Main::main()
{
    ...
    time[0] = system.getTimeNs();
    for(int32 i=0; i<1000000; i++)
    {
        rsem.acquire(1);
        isem.release(1);
    }
    time[1] = system.getTimeNs();
